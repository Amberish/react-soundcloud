...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexPage = function (_Component) {
	  ...
	  _createClass(IndexPage, [{
	    ...
	    value: function songList() {
	      ...
	      return $this.state.tracks.map(function (track) {
	        return _react2.default.createElement(
	          ...
	          '   ',
	          _react2.default.createElement('img', { src: track.user.avatar_url, style: { height: "50px" } }),
	          '   ',
	          track.title
	        );
	      });
	    ...
	    key: 'onGenreSelect',
	    value: function onGenreSelect(e) {
	      var source = e.target;
	    ...
	    key: 'onArtistSelect',
	    value: function onArtistSelect(e) {
	      var source = e.target;
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'select',
	                      { className: 'form-control', onChange: this.onArtistSelect.bind(this) },
	                      _react2.default.createElement(
	                        'option',
	                        null,
	                        'artist'
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'select',
	                      { className: 'genre-select form-control', onChange: this.onGenreSelect.bind(this) },
	                      _react2.default.createElement(
	                        'option',
	                        null,
	                        'select genre'
	  ...
	  _createClass(Player, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "container-fluid player-container row" },
	          _react2.default.createElement(
	            "div",
	            { className: "player-controls col-md-1" },
	            _react2.default.createElement("i", { className: "fa fa-backward fa-2x" }),
	            " ",
	            _react2.default.createElement("i", { className: "fa fa-play-circle fa-2x" }),
	            " ",
	            _react2.default.createElement("i", { className: "fa fa-forward fa-2x" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "col-md-6 player-progress" },
	            _react2.default.createElement(
	              "div",
	              { className: "progress", style: { height: "5px" } },
	              _react2.default.createElement("div", { className: "progress-bar progress-bar-warning", style: { "width": "60%" } })
	            )
	          ),
	          _react2.default.createElement(
	            "div",
	            ...
	            _react2.default.createElement(
	              "div",
	              { className: "volume-control col-md-4" },
	              _react2.default.createElement("i", { className: "fa fa-volume-up fa-2x" })
	            ),
	            _react2.default.createElement(
	              "div",
	              { className: "volume-level col-md-8" },
	              _react2.default.createElement(
	                "div",
	                { className: "progress", onClick: this.volumeChange },
	                _react2.default.createElement("div", { className: "progress-bar progress-bar-warning", style: { "width": this.state.volume + "%" } })
	              )
	            )
	          )
	        )
